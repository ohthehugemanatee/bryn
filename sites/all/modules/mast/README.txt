...
This module is currently being developed against the latest stable releases of
Services and OAuth, Services 7.x-3.1 and OAuth 7.x-3.0. There are minor API
changes in the Services module that will, at the least, break the included tests
if run against the latest 7.x-3.x Services and OAuth modules.
